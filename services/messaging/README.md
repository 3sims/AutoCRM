# messaging — Standalone Microservice (future)

This directory is the **extraction target** for the `messaging` domain module.

## Current state
The `messaging` logic lives in `apps/api/src/modules/messaging/`.

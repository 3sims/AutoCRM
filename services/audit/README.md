# audit — Standalone Microservice (future)

This directory is the **extraction target** for the `audit` domain module.

## Current state
The `audit` logic lives in `apps/api/src/modules/audit/`.

# notifications — Standalone Microservice (future)

This directory is the **extraction target** for the `notifications` domain module.

## Current state
The `notifications` logic lives in `apps/api/src/modules/notifications/`.

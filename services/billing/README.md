# billing — Standalone Microservice (future)

This directory is the **extraction target** for the `billing` domain module.

## Current state
The `billing` logic lives in `apps/api/src/modules/billing/`.

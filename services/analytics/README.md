# analytics — Standalone Microservice (future)

This directory is the **extraction target** for the `analytics` domain module.

## Current state
The `analytics` logic lives in `apps/api/src/modules/analytics/`.

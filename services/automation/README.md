# automation — Standalone Microservice (future)

This directory is the **extraction target** for the `automation` domain module.

## Current state
The `automation` logic lives in `apps/api/src/modules/automation/`.
